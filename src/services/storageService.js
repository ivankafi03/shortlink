...
<head>
  ...
  <style>
    ...
    .avatar { width: 80px; height: 80px; border-radius: 50%; background: #e11d48; color: white; display: inline-flex; align-items: center; justify-content: center; font-size: 2rem; font-weight: bold; margin-bottom: 1rem; }
    ...
    .link-btn:hover { border-color: #e11d48; color: #e11d48; }
  </style>
</head>
<body>
  <div class="container">
