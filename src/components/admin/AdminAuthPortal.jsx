    ...
    loadGoogleSdk()
      .then((googleAuth) => {
        if (activeId && googleBtnRef.current) {
          ...
          // Calculate button width to fit small screens perfectly
          const screenW = typeof window !== 'undefined' ? window.innerWidth : 360;
          const btnWidth = Math.min(300, Math.max(240, screenW - 80));
  ...
  return (
    <div style={{
      ...
      <div className="neu-panel" style={{
        maxWidth: '400px',
        width: '100%',
        padding: 'clamp(1.75rem, 5vw, 2.5rem) clamp(1.15rem, 4vw, 1.85rem)',
        borderRadius: '18px',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '1.5rem' }}>
          ...
          <h1 style={{ fontSize: 'clamp(1.2rem, 4.5vw, 1.4rem)', fontWeight: 900, letterSpacing: '-0.02em', color: 'var(--text-main)', margin: '0 0 0.35rem', lineHeight: 1.25 }}>
            Admin Portal
          </h1>
          <p style={{ fontSize: 'clamp(0.775rem, 3.2vw, 0.85rem)', color: 'var(--text-muted)', fontWeight: 600, margin: 0, lineHeight: 1.4 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.5rem', width: '100%', minHeight: '44px' }}>
          <div 
            ref={googleBtnRef} 
          ...
          {!sdkRendered && (
            ...
            >
              ...
              <span style={{ fontSize: '0.85rem', fontWeight: 700, color: '#3c4043', fontFamily: 'Roboto, sans-serif' }}>
