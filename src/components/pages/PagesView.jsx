...
<head>
  ...
  <style>
    ...
    .btn { display: inline-block; margin-top: 1.25rem; background: #f472b6; color: white; padding: 0.75rem 1.5rem; border-radius: 8px; text-decoration: none; font-weight: bold; }
  </style>
</head>
<body>
  <div class="card">
