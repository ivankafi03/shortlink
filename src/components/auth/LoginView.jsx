...
export const LoginView = ({ onLoginSuccess, onNavigate }) => {
  ...
  return (
    <div className="auth-page-container" style={{
      ...
      {/* Wrapper to control max width & top back button cleanly */}
      <div style={{ maxWidth: '400px', width: '100%', display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
        ...
        <div className="neu-panel" style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '1.5rem' }}>
            ...
            <p style={{ fontSize: 'clamp(0.775rem, 3.2vw, 0.85rem)', color: 'var(--text-muted)', fontWeight: 600, margin: 0, lineHeight: 1.45 }}>
